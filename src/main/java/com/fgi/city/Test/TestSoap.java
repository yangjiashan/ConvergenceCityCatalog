...
public class TestSoap {
    ...
    @WebMethod
    public String testSoap(@WebParam(name = "username") String username, @WebParam(name = "password") String password) {
    ...
    @WebMethod
    public String testSoapNeedGuid(@WebParam(name = "guid") String guid, @WebParam(name = "content") String content) {
        Document responseDoc = DocumentHelper.createDocument();
        Element responseElement = responseDoc.addElement("Response");
        Element responseCode = responseElement.addElement("code");
        Element responseMessage = responseElement.addElement("message");
